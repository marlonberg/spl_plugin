...
public class SplProcusageImpl extends ASTWrapperPsiElement implements SplProcusage {

  public SplProcusageImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SplVisitor visitor) {
    visitor.visitProcusage(this);
  }
