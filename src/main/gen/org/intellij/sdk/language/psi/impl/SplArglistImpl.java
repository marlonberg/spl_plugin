...
public class SplArglistImpl extends ASTWrapperPsiElement implements SplArglist {

  public SplArglistImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SplArglist> getArglistList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SplArglist.class);
  }
